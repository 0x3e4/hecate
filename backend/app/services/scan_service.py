...
class ScanService:
    ...
    async def get_target_history(
        ...
        return await self.scan_repo.get_history(target_id, limit=limit, since=since, offset=offset)

    async def count_target_history(self, target_id: str, since: datetime | None = None) -> int:
        return await self.scan_repo.count_history(target_id, since=since)
